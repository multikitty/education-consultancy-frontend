...
export function LeadsByStatus() {
  ...
  const { leads, universities, interestedPrograms } = useSelector((state) => state?.universitiesReducer);
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-lg font-normal text-[#333]">
                      {/* {lead?.ProgrameDetail?.schoolName
                        ...
                        : "No Program Found"} */}
                        {
                          interestedPrograms?.data?.faqs.map(ele => ele.ID == lead?.ProgrameDetail?.interestedProgramme && ele.name)
                        }
                    </td>
                    <td className="px-6 py-4 text-lg font-normal text-[#333]">
                      {/* {lead?.University?.name} */}
                      {
                        universities?.data?.faqs.map(ele => ele.id == lead?.ProgrameDetail?.selectUniversity && ele.name)
                      }
                    </td>
                    <td className="px-6 py-4 text-lg font-normal text-[#333]">
                      {lead?.Branch?.name}
