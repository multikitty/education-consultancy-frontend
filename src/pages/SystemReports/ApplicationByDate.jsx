...
export function ApplicationByDate() {
  ...
  const { applications, universities, interestedPrograms } = useSelector((state) => state?.universitiesReducer);
                  ...
                  ({
                    ...
                    <tr key={name + id + "_ooehnv_" + date}>
                      ...
                      <td className="px-6 py-4 text-lg font-semibold text-[#333]">
                        ...
                        {
                          interestedPrograms?.data?.faqs.map(ele => ele.ID == ApplicationDetail?.interestedProgramme && ele.name)
                        }
                      </td>
                      <td className="px-6 py-4 text-lg font-semibold text-[#333]">
...
export default ApplicationByDate;
