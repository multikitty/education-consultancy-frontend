...
export function General() {
  ...
  const { generalInvoices } = useSelector(
    (state) => state?.universitiesReducer
  );
  console.log("General Invoices from Module:", generalInvoices);
  useEffect(() => {
  ...
  const onConfirmation = async () => {
    ...
    const data = await axios.delete(
      `${ENV.baseUrl}/generalinvoice/delete/${idToDelete}`
    );
    console.log("deleted data", data);
    dispatch(listGeneralInvoices(generalInvoices?.data?.faqs.pagination));
        ...
        <div>
          <div className=" rounded-[34px] bg-white p-6 md:p-12">
            <div className="my-0 flex w-full flex-col justify-between gap-3 pt-0 pb-5 sm:flex-row sm:items-center">
              ...
              <NavLink to="createInvoice/type/general">
                        ...
                        <td>
                          <Button
                            ...
                            onClick={
                              () =>
                                navigate(
                                  `/dashboard/InvoiceManagement/type/general/1/${ID}`
                                )
                            ...
                            >
                              <li>
                                <button
                                  ...
                                  onClick={() =>
                                    navigate(
                                      `/dashboard/InvoiceManagement/type/general/2/${ID}`
                                    )
                                  }
                                >
                                  Edit
            ...
            <Paginate
              pagination={generalInvoices?.data?.pagination}
              method={listGeneralInvoices}
            />
          </div>
        </div>
      </div>
